...
public:
  ...
  inline float getTpmsPressureFl() const;

  inline float getTpmsPressureFr() const;

  inline float getTpmsPressureRl() const;

  inline float getTpmsPressureRr() const;
...
public:
  ...
  inline float getTpmsPressureFl();
  inline void setTpmsPressureFl(float value);

  inline float getTpmsPressureFr();
  inline void setTpmsPressureFr(float value);

  inline float getTpmsPressureRl();
  inline void setTpmsPressureRl(float value);

  inline float getTpmsPressureRr();
  inline void setTpmsPressureRr(float value);
...
inline float CarState::Reader::getTpmsPressureFl() const {
  return _reader.getDataField<float>(
      ::capnp::bounded<13>() * ::capnp::ELEMENTS);
}

inline float CarState::Builder::getTpmsPressureFl() {
  return _builder.getDataField<float>(
      ::capnp::bounded<13>() * ::capnp::ELEMENTS);
}
inline void CarState::Builder::setTpmsPressureFl(float value) {
  _builder.setDataField<float>(
      ::capnp::bounded<13>() * ::capnp::ELEMENTS, value);
}

inline float CarState::Reader::getTpmsPressureFr() const {
  return _reader.getDataField<float>(
      ::capnp::bounded<14>() * ::capnp::ELEMENTS);
}

inline float CarState::Builder::getTpmsPressureFr() {
  return _builder.getDataField<float>(
      ::capnp::bounded<14>() * ::capnp::ELEMENTS);
}
inline void CarState::Builder::setTpmsPressureFr(float value) {
  _builder.setDataField<float>(
      ::capnp::bounded<14>() * ::capnp::ELEMENTS, value);
}

inline float CarState::Reader::getTpmsPressureRl() const {
  return _reader.getDataField<float>(
      ::capnp::bounded<15>() * ::capnp::ELEMENTS);
}

inline float CarState::Builder::getTpmsPressureRl() {
  return _builder.getDataField<float>(
      ::capnp::bounded<15>() * ::capnp::ELEMENTS);
}
inline void CarState::Builder::setTpmsPressureRl(float value) {
  _builder.setDataField<float>(
      ::capnp::bounded<15>() * ::capnp::ELEMENTS, value);
}

inline float CarState::Reader::getTpmsPressureRr() const {
  return _reader.getDataField<float>(
      ::capnp::bounded<16>() * ::capnp::ELEMENTS);
}

inline float CarState::Builder::getTpmsPressureRr() {
  return _builder.getDataField<float>(
      ::capnp::bounded<16>() * ::capnp::ELEMENTS);
}
inline void CarState::Builder::setTpmsPressureRr(float value) {
  _builder.setDataField<float>(
      ::capnp::bounded<16>() * ::capnp::ELEMENTS, value);
}
